...
struct CallAI: View {
    ...
    @State private var inputImage: UIImage? = UIImage(named: "AMD")
    ...
    func processImage() {
        ...
        let uploadURL="https://askai.aiclub.world/d00a3c7b-c2aa-4d92-b082-8160dc84bcec"
        ...
        AF.upload(imageB64, to: uploadURL).responseJSON { response in
            ...
            switch response.result {
               case .success(let responseJsonStr):
                ...
                if(predictionMessage=="Normal") {
                    self.animalName="Normal scan"
                }
                else if(predictionMessage == "Category1") {
                    self.animalName="Early AMD scan"
                }
                else if(predictionMessage ==  "Category2") {
                    self.animalName="Advanced AMD scan"
                }
